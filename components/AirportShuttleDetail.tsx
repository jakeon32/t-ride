...
const AirportShuttleDetail: React.FC = () => {
    ...
    <div className="min-h-screen flex flex-col bg-slate-50">
      ...
      <main className="flex-grow">
            ...
            <div className="relative h-[280px] md:h-[340px] w-full rounded-[1.5rem] md:rounded-[2.5rem] overflow-hidden">
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-6 md:p-12 z-10">
                ...
                <nav className="text-white/70 text-xs md:text-sm mb-4 font-medium">
                  ...
                  <span className="mx-2">›</span>
                  <span className="text-white">인천공항 ↔ 서울</span>
                </nav>
                <div className="flex flex-wrap items-center gap-2 mb-3">
                  <span className="bg-blue-500 text-white text-[11px] font-bold px-2.5 py-1 rounded">셔틀(버스)</span>
                  <span className="bg-emerald-500 text-white text-[11px] font-bold px-2.5 py-1 rounded">운영 중</span>
                </div>
                <h1 className="text-2xl md:text-4xl font-extrabold text-white mb-2 [text-shadow:_0_2px_12px_rgba(0,0,0,0.3)]">
                  인천공항 → 서울 셔틀
                </h1>
                <div className="flex flex-wrap gap-2 mt-2">
                  {['공항 셔틀', '시간표 기반', '단체 문의 가능'].map((tag) => (
              ...
              <div className="lg:col-span-2 space-y-8">
                ...
                <div className="bg-white rounded-2xl border border-slate-200 p-6 md:p-8">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {[
                      { label: '운행 구간', value: '인천공항 ↔ 서울 도심' },
                      { label: '예상 소요', value: '약 60–80분' },
                      { label: '운행 형태', value: '시간표 기반 셔틀' },
                      { label: '대상', value: '공항 이용 승객' },
                    ].map((item) => (
                ...
                <div className="bg-white rounded-2xl border border-slate-200 p-6 md:p-8">
                  ...
                  <ul className="space-y-3 text-sm text-slate-600 leading-relaxed">
                    <li className="flex gap-3">
                      ...
                      <span><strong className="text-slate-800">운행 시간:</strong> 매일 06:00 – 22:00 (첫차 06:00 / 막차 22:00)</span>
                    </li>
                    <li className="flex gap-3">
                      <span className="text-blue-500 font-bold shrink-0">•</span>
                      <span><strong className="text-slate-800">배차 간격:</strong> 약 30분–1시간 간격</span>
                    </li>
                    <li className="flex gap-3">
                      <span className="text-blue-500 font-bold shrink-0">•</span>
                      <span><strong className="text-slate-800">예약 방식:</strong> 사전 예약 필수 (당일 잔여석 탑승 가능)</span>
                    </li>
                    <li className="flex gap-3">
                      <span className="text-blue-500 font-bold shrink-0">•</span>
                      <span><strong className="text-slate-800">탑승 조건:</strong> 예약 확인 바우처 또는 QR코드 제시</span>
                    </li>
                    <li className="flex gap-3">
                      <span className="text-blue-500 font-bold shrink-0">•</span>
                      <span><strong className="text-slate-800">지연·취소:</strong> 출발 2시간 전까지 무료 취소 / 지연 시 카카오톡 알림</span>
                    </li>
                  </ul>
                </div>
                ...
                {/* 탑승·하차 안내 */}
                <div className="bg-white rounded-2xl border border-slate-200 p-6 md:p-8">
                  <h2 className="text-lg font-bold text-slate-900 mb-5">탑승 · 하차 위치</h2>
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="bg-slate-50 rounded-xl p-5">
                      <h3 className="text-sm font-bold text-slate-800 mb-3">탑승지 (공항)</h3>
                      <ul className="space-y-2 text-sm text-slate-600">
                        <li>• 인천공항 T1 – 1층 8번 출구 셔틀 정류장</li>
                        <li>• 인천공항 T2 – 1층 3번 출구 셔틀 정류장</li>
                      </ul>
                    </div>
                    <div className="bg-slate-50 rounded-xl p-5">
                      <h3 className="text-sm font-bold text-slate-800 mb-3">하차지 (서울)</h3>
                      <ul className="space-y-2 text-sm text-slate-600">
                        <li>• 서울역</li>
                        <li>• 강남역 (신논현)</li>
                        <li>• 홍대입구역</li>
                    ...
                    <table className="w-full text-sm">
                      <thead>
                        <tr className="border-b border-slate-200">
                          ...
                          <th className="text-left py-3 font-bold text-slate-800">왕복</th>
                        </tr>
                      </thead>
                      <tbody className="text-slate-600">
                        <tr className="border-b border-slate-100">
                          <td className="py-3 pr-4 font-medium">성인 1인</td>
                          <td className="py-3 pr-4">17,000원</td>
                          <td className="py-3">30,000원</td>
                        </tr>
                        <tr className="border-b border-slate-100">
                          <td className="py-3 pr-4 font-medium">소아 (만 3–12세)</td>
                          <td className="py-3 pr-4">12,000원</td>
                          <td className="py-3">22,000원</td>
                        </tr>
                        <tr>
                          <td className="py-3 pr-4 font-medium">단체 (10인 이상)</td>
                          <td className="py-3 pr-4" colSpan={2}>별도 문의</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                ...
                <div className="bg-white rounded-2xl border border-slate-200 p-6 md:p-8">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-base font-bold text-slate-800 mb-1">T-Ride Partner A</h3>
                      <p className="text-sm text-slate-500 mb-2">공항 셔틀 전문 운송사 · 운영 8년차</p>
                      <p className="text-xs text-slate-400">전 차량 보험 가입 완료 · 안전 운행 인증</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="lg:col-span-1">
                <div className="lg:sticky lg:top-24 space-y-4">
                  <div className="bg-white rounded-2xl border border-slate-200 p-6">
                    <p className="text-sm text-slate-500 mb-1">편도 기준</p>
                    <p className="text-2xl font-extrabold text-slate-900 mb-4">17,000원~</p>
                    <button className="w-full py-3.5 rounded-xl bg-blue-600 text-white font-bold text-sm hover:bg-blue-700 transition-colors mb-3">
                      예약하러 가기
                    </button>
                    <button
                  ...
                  <div className="bg-slate-100 rounded-2xl p-5">
                    <p className="text-xs text-slate-500 leading-relaxed">
                      예약 확정 후 출발 2시간 전까지 무료 취소 가능합니다.
                      단체 예약(10인 이상)은 문의하기를 이용해 주세요.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-slate-200 px-5 py-4 z-40 flex gap-3">
          ...
          <button className="flex-[2] py-3.5 rounded-xl bg-blue-600 text-white font-bold text-sm">
            예약하러 가기
          </button>
        </div>
      </main>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
          <div className="bg-white rounded-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto p-6 md:p-8">
            ...
            <div className="bg-slate-50 rounded-xl p-4 mb-6 space-y-1">
              <p className="text-xs text-slate-400">상품명: <span className="text-slate-600 font-medium">인천공항 → 서울 셔틀</span></p>
              <p className="text-xs text-slate-400">서비스 타입: <span className="text-slate-600 font-medium">셔틀(버스)</span></p>
            </div>
            ...
            <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); alert('문의가 접수되었습니다.'); setShowInquiry(false); }}>
              ...
              {/* 탑승지 */}
              <div>
                <label className="block text-sm font-bold text-slate-700 mb-2">탑승지 (정류장)</label>
                <input type="text" placeholder="예: 인천공항 T1 3층 5B 정류장" className="w-full px-4 py-3 rounded-xl border border-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-300" />
                <p className="text-xs text-slate-400 mt-1">정류장은 안내된 리스트에서 선택해 주세요.</p>
              </div>
              ...
              <div>
                ...
                <textarea placeholder="예: 대형 수하물 2개, 유아 동반" rows={2} className="w-full px-4 py-3 rounded-xl border border-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-300 resize-none" />
              </div>
              ...
              <button type="submit" className="w-full py-3.5 rounded-xl bg-blue-600 text-white font-bold text-sm hover:bg-blue-700 transition-colors mt-2">
                문의 보내기
              </button>
            </form>
          </div>
...
export default AirportShuttleDetail;
